...
export function startGame() {
  ...
  // fade out between start screen and scene 1
...
export function quitGame() {
  ...
  // animation fade out between any point in the game and start screen
...
function resetInventory() {
  collectedRelics.length = 0; // Clear array without reassigning
